...
out_dir = "/Users/hazel/Desktop/lab/first_task/sig_2sub_graphs"
...
for query in df_all["Query ID"].unique():
    ...
    # Identify significant shared regions (covered by ≥2 distinct subjects)
    sig_regions = []
    in_region = False
    region_start = None
    ...
    ax.set_yticks([])
    ax.set_title(f"Query: {query} (coverage >= 2/11)")
